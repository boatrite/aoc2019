...
def manhatten_distance(intersection)
  intersection[:x].abs + intersection[:y].abs
end

min_intersection = intersections.first

intersections.each { |intersection|
  if manhatten_distance(intersection) < manhatten_distance(min_intersection)
    min_intersection = intersection
  end
}

puts min_intersection
puts manhatten_distance(min_intersection)
